...
def self_test():
    ...
    # 70 shipped namelists + the 115 generated vertical-coordinate matrix
    ...
    check("manifest covers 70 shipped namelists + the vcoord matrix "
          "({} base cases, {} of them matrix cells, {} at tier 2)"
          .format(len(base), len(vcm), n2),
          len(base) - len(vcm) == 70 and len(vcm) == 115)
